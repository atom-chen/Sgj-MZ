...
namespace App.Service
{
    public class SBase
    {
        public IEnumerator Download(string url, int ver, System.Action<AssetBundle> handle, bool destory = true, bool showMask = true)
        {
            Debug.Log("url=" + url);
            bool showConnecting = false;
            if (showMask && Util.Global.AppManager != null && 
